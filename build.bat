...
set includes=/I ../my_lib/ /I ../external/ /I ../external/D3D12/headers/d3dx12/ /I ../external/D3D12/headers/ 
set linkerFlags=/OUT:DeRex12.exe /INCREMENTAL:NO /OPT:REF /CGTHREADS:6 /STACK:0x100000,0x100000 
set linkerLibs=user32.lib gdi32.lib winmm.lib dxguid.lib dxgi.lib d3d12.lib
...
cl.exe %compilerFlags% ../source/Win32_x64_Platform.cpp ../source/Game.cpp ../external/D3D12MemAlloc.cpp /link %linkerFlags% %linkerLibs%
popd