...
set linkerFlags=/OUT:DeRex12.exe /INCREMENTAL:NO /OPT:REF /CGTHREADS:6 /STACK:0x100000,0x100000 user32.lib gdi32.lib winmm.lib dxgi.lib d3d12.lib D3DCompiler.lib
...
if "%~1"=="-Debug" (
	echo [[ debug build ]]
	set compilerFlags=%common_compiler% /Od /D_DEBUG /DD3DCOMPILE_DEBUG
)
if "%~1"=="-Release" (
	echo [[ release build ]]
